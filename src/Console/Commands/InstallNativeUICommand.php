...
{
    protected $signature = 'w4-native-ui:install {--force : Sobrescribe archivos publicados existentes} {--build : Compila assets antes de publicar} {--inertia : Publica componentes para Inertia (Vue/React) en resources/js/vendor/w4-native-ui}';
    ...
    public function handle(): int
    {
        ...
        if ((bool) $this->option('inertia')) {
            $this->components->info('Publicando componentes Inertia (Vue/React) de W4-Native UI...');
            $this->call('vendor:publish', [
                '--tag' => 'w4-native-ui-inertia',
                '--force' => (bool) $this->option('force'),
            ]);
        }
